...
ip l set k8s-api up
ip addr add 3.3.3.3/32 dev k8s-api
...
#since no pods will be deplayed here CNI will not kick in
ip addr add 172.21.0.1/24 dev green-l2
ip addr add 172.20.0.1/24 dev red-l2
